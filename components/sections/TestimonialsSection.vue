...
const data = computed(() => locale.value === 'fr' ? testimonialsFR : locale.value === 'ar' ? testimonialsAR : testimonialsEN)
...
function measureHeight() {
  ...
  if (card) {
    wrapperHeight.value = (card as HTMLElement).offsetHeight + 32
  }
}
